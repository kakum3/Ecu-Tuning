            ...
            <div  className="container-fluid marketing text-center">
                <div className="row">
                    <div className="col-lg-4">
                        ...
                        <em className="home-shadow py-3 mb-4 text-white"> "El Rápido"</em>
                    ...
                    <div className="col-lg-4">
                        ...
                        <h2 className="home-shadow py-3 mb-4 fs-4 mb-4 t-shadow-black text-white">Jesús</h2>
                        <em className="text-white">"El Grafitis"</em>
