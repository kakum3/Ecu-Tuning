            ...
            <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 bg-light">
                <div class="col-md-12 p-lg-5 mx-auto my-5">
                    ...
                    <p class="lead">
                        ...
                        <p>En Ecu Tunning, trataremos tus datos personales recabados a través del Sitio Web:</p>
                        <p>https://www.ecutunning.com/, con las siguientes finalidades:</p>
                        ...
                        <p>1. La solicitud de información y/o la contratación de los servicios de Ecu Tunning, cuyos términos y condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.</p>
                        ...
                        <p>Los datos no se comunicarán a ningún tercero ajeno a Ecu Tunning, salvo obligación legal.</p>
                        ...
                        <p>Derechos propiedad intelectual https://www.ecutunning.com/</p>
                        <p>Ecu Tunning es titular de todos los derechos de autor, propiedad intelectual, industrial, "know how" y cuantos otros derechos guardan relación con los contenidos del sitio web https://www.ecutunning.com/ y los servicios ofertados en el mismo, así como de los programas necesarios para su implementación y la información relacionada.</p>
                        <p>No se permite la reproducción, publicación y/o uso no estrictamente privado de los contenidos, totales o parciales, del sitio web https://www.ecutunning.com/ sin el consentimiento previo y por escrito.</p>
                        <h5>Propiedad intelectual del software</h5>
                        <p>El usuario debe respetar los programas de terceros puestos a su disposición por Ecu Tunning, aún siendo gratuitos y/o de disposición pública.</p>
                        <p>Ecu Tunning dispone de los derechos de explotación y propiedad intelectual necesarios del software.</p>
                        ...
                        <p>Para toda actuación que exceda del cumplimiento del contrato, el usuario necesitará autorización por escrito por parte de Ecu Tunning, quedando prohibido al usuario acceder, modificar, visualizar la configuración, estructura y ficheros de los servidores propiedad de Ecu Tunning, asumiendo la responsabilidad civil y penal derivada de cualquier incidencia que se pudiera producir en los servidores y sistemas de seguridad como consecuencia directa de una actuación negligente o maliciosa por su parte.</p>
                        <h5>Propiedad intelectual de los contenidos alojados</h5>
                        <p>Se prohíbe el uso contrario a la legislación sobre propiedad intelectual de los servicios prestados por Ecu Tunning y, en particular de:</p>
                        <p>• La utilización que resulte contraria a las leyes españolas o que infrinja los derechos de terceros.</p>
                        <p>• La publicación o la transmisión de cualquier contenido que, a juicio de Ecu Tunning, resulte violento, obsceno, abusivo, ilegal, racial, xenófobo o difamatorio.</p>
                        ...
                        <p>El usuario indemnizará a Ecu Tunning por los gastos que generara la imputación de Ecu Tunning en alguna causa cuya responsabilidad fuera atribuible al usuario, incluidos honorarios y gastos de defensa jurídica, incluso en el caso de una decisión judicial no definitiva.</p>
                        <h5>Protección de la información alojada</h5>
                        <p>Ecu Tunning realiza copias de seguridad de los contenidos alojados en sus servidores, sin embargo no se responsabiliza de la pérdida o el borrado accidental de los datos por parte de los usuarios. De igual manera, no garantiza la reposición total de los datos borrados por los usuarios, ya que los citados datos podrían haber sido suprimidos y/o modificados durante el periodo del tiempo transcurrido desde la última copia de seguridad.</p>
                        <p>Los servicios ofertados, excepto los servicios específicos de backup, no incluyen la reposición de los contenidos conservados en las copias de seguridad realizadas por Ecu Tunning, cuando esta pérdida sea imputable al usuario; en este caso, se determinará una tarifa acorde a la complejidad y volumen de la recuperación, siempre previa aceptación del usuario.</p>
                        <p>La reposición de datos borrados sólo está incluida en el precio del servicio cuando la pérdida del contenido sea debida a causas atribuibles a Ecu Tunning.</p>
                        ...
                        <p>En todo caso, el usuario, tras acreditar su identidad, podrá solicitar que no se le haga llegar más información comercial a través de los canales de Atención al Cliente.</p></p>
                </div>
            </div>
        </div>
    );
