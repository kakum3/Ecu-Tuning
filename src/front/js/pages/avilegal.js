        ...
        <main className="container-fluid">
            <div  className="position-relative overflow-hidden p-3 p-md-5 m-md-3 bg-light">
                <div  className="col-md-12 p-lg-5 mx-auto">
                    <h2 className="featurette-heading fw-normal lh-1 text-danger">AVISO LEGAL<span  className="text-muted"> Ecu Tunning</span></h2>
                    En cumplimiento con el deber de información recogido en artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), el propietario de la web https://www.ecutunning.com/, le informa de lo siguiente:
                        ...
                        <p>Asimismo, le informamos de la posibilidad de que ejerza los derechos de acceso, rectificación, cancelación y oposición de sus datos de carácter personal, manera gratuita mediante email a administracion@ecutunning.com o en la dirección Calle Ecu Tunning, 13</p>
                </div>
            </div>
        </main>
    );
